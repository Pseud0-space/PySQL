...
class ImageStore(QMainWindow):
    def __init__(self):
        ...
        self.MainLabel.setText("Insert Student Image")
    ...
    def ShwSuc(self):
        ...
        msgBox.setText("Image Inserted Successfully")
    ...
    def backend(self):
        ...
        if status == True:
            ...
            qu = f"insert into image values({stuID}, '{imgStr}')"
